...
<body class="bg-dark">
    <div class="overflow-x-hidden">
        ...
        <header id="sticky-header" class="white-header bg-dark">
            <div class="d-flex justify-content-between header-inner">
                ...
                <div class="header-border-bottom d-flex align-items-center justify-content-between flex-grow-1">
                    ...
                    <!-- Link Start -->
                    <a href="contact.php" class="d-flex align-items-center flex-wrap fw-bold text-dark lh-1 contact-link">İletişime Geçin
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" />
                ...
                <!-- Button Start -->
                <button id="offcanvas-toggle" class="bg-black border-0 offcanvas-toggle" data-bs-toggle="offcanvas" data-bs-target="#offcanvas" aria-controls="offcanvas">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="bg-dark pt-20 pb-120">
                ...
                <div class="row">
                    <div class="col-12" data-aos="flip-down" data-aos-delay="400">
                        <div class="fw-bold font-Syne text-center leading-none d-flex flex-wrap flex-column gap-y-2 mb-10">
                            ...
                            <h3 class="section-title text-white">Son Çalışma <span
                                    class="position-relative circle-shape portfolio-shape">la</span>rım</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-grid">
                        <div class="pt-12">
                            ...
                            <div class="d-flex flex-wrap align-items-center mt-10">
                                <span class="text-xl fw-bold font-Syne text-white">Türkiye |</span>
